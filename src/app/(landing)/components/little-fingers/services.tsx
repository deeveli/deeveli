              ...
              >
                ...
                <div className={cn('sm:w-full lg:w-7/12', 'sm:px-0 lg:pl-5')}>
                  <Carousel>
                    <CarouselContent>
                      {projectPictures
                        .filter((serv) => serv.slug.includes(service.slug)
                          && clients.filter((archived) => archived.archived === 'No'))
                          .map((imagePic) =>
                      ...
                      {deeveliData.serviceImages.map((images, index) => (
                        <>
                          <CarouselItem key={index} className="flex size-auto  bg-slate-200 dark:bg-slate-800 lg:items-center lg:justify-center">
