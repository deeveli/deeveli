export const PearsonOld = {
  // Basic Information
  id: 10,
  color: 'bg-black-900',
  color2: 'bg-gold-500 dark:bg-opacity-0',
  name: 'Pearson Consultancy',
  slug: 'pearson-consultancy-old',
  logo: '/media/works/pearson-consultancy-old/logo.png',
  src: '/works/pearson-consultancy-old',
  workCategory: ['All Works', 'Websites'],
  featured: 'No',
  archived: 'Yes',

  // Hero Section
  image: '/media/works/pearson-consultancy/pearson-consultancy-1.jpg',
  video: '/media/works/pearson-consultancy/pearson-consultancy-1.mp4',
  imageA: '/media/works/pearson-consultancy/pearson-consultancy-2.jpg',
  imageB: '/media/works/pearson-consultancy/pearson-consultancy-3.jpg',
  alt: 'pearson-consultancy-ux-case-study',
  ...
  link: 'www.pearsonconsultancy.com', // Placeholder link

  // Section One: Expertise Showcase
  image1a: '/media/works/pearson-consultancy/pearson-consultancy-5.jpg',
  image1b: '/media/works/pearson-consultancy/pearson-consultancy-4.jpg',
  alt1a: 'pearson-consultancy-ux-case-study',
  alt1b: 'pearson-consultancy-ux-case-study',
  video1a: '/media/works/pearson-consultancy/pearson-consultancy-2.mp4',
  video1b: '/media/works/pearson-consultancy/pearson-consultancy-3.mp4',
  ...
  image2a: '/media/works/pearson-consultancy/pearson-consultancy-7.jpg',
  image2b: '/media/works/pearson-consultancy/pearson-consultancy-6.jpg',
  alt2a: 'pearson-consultancy-ux-case-study',
  alt2b: 'pearson-consultancy-ux-case-study',
  ...
  image3a: '/media/works/pearson-consultancy/pearson-consultancy-8.jpg',
  alt3a: 'pearson-consultancy-ux-case-study',
  ...
  image4a: '/media/works/pearson-consultancy/pearson-consultancy-10.jpg',
  image4b: '/media/works/pearson-consultancy/pearson-consultancy-11.jpg',
  alt4a: 'pearson-consultancy-ux-case-study',
  alt4b: 'pearson-consultancy-ux-case-study',
